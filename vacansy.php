						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">Имя Вакансии</th>
									<th class="cell100 column2">Email Компании</th>
									<th class="cell100 column3">Зарплата</th>
									<th class="cell100 column4">Описание</th>
									<th class="cell100 column5">Требования</th>
								</tr>
							</thead>
						</table>
					</div>
...
if (isset($_COOKIE['id']))
{
	    $query = mysql_query('SELECT * FROM Vacansy');
						...
						<table>
							<tbody>
								<tr class="row100 body">
									...
									<td class="cell100 column2">'.$data['Email_company'].'</td>
									<td class="cell100 column3">'.$data['Salary'].'$</td>
									<td class="cell100 column4">'.$data['Description'].'</td>
									<td class="cell100 column5">'.$data['Req'].'</td>
								</tr>
							</tbody>
						</table>
</div>';	
